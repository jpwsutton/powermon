 ...
 */
	...
	// Returns a range of years starting with 2011
	   this.years = function(startYear) {
            var currentYear = new Date().getFullYear(), years = [];
            startYear = startYear || 2011;
...
function updateDay(day){
	...
	//URL
	var dayTotalEnergyURL = "includes/get_power_data.php?mode=watts&startDate=" + startDate + "%2000:00:00&endDate=" + endDate + "%2000:00:00&device=main"
...
function updateMonth(month) {
	...
	//URL
	var monthTotalEnergyURL = "includes/get_power_history.php?mode=watts&startDate=" + monthStartDate + "%2000:00:00&endDate=" + monthEndDate + "%2000:00:00&device=main";
...
function updateYear(year) {
	...
	//URL
	var yearTotalEnergyURL = "includes/get_power_history.php?mode=watts&startDate=" + yearStartDate + "%2000:00:00&endDate=" + yearEndDate + "%2000:00:00&device=main";
